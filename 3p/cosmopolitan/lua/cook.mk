...
$(lua_bin): o/3p/cosmopolitan 3p/cosmopolitan/lua/linit.c.patch 3p/cosmopolitan/lua/BUILD.mk.patch
	mkdir -p o/3p/lua
	cd $(cosmopolitan_src)/third_party/lua && patch -p0 -N < $(CURDIR)/3p/cosmopolitan/lua/linit.c.patch || true
	...
	cd $(cosmopolitan_src)/third_party/lua && patch -p0 -N < $(CURDIR)/3p/cosmopolitan/lua/BUILD.mk.patch || true
	cd $(cosmopolitan_src) && rm -f o//third_party/lua/lua.a.pkg o//third_party/lua/lua.pkg o//third_party/lua/lua
	cd $(cosmopolitan_src) && $(make) -j8 o//third_party/argon2/argon2.a.pkg o//third_party/sqlite3/sqlite3.a.pkg
...
3p/cosmopolitan/lua/test: $(lua_bin)
	$(lua) 3p/cosmopolitan/lua/test_unix.lua
	$(lua) 3p/cosmopolitan/lua/test_modules.lua
	$(lua) 3p/cosmopolitan/lua/test_re.lua
	$(lua) 3p/cosmopolitan/lua/test_path.lua
	$(lua) 3p/cosmopolitan/lua/test_argon2.lua
	$(lua) 3p/cosmopolitan/lua/test_sqlite.lua

.PHONY: 3p/cosmopolitan/lua/test
